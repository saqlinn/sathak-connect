      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {highlights.map((item, index) => (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-primary/10 flex items-center justify-center group-hover:shadow-neon transition-all duration-500">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="card-premium p-8 flex items-center gap-6 group hover:border-primary/50 transition-all duration-500">
            <div className="w-20 h-20 rounded-2xl bg-gradient-neon flex items-center justify-center shrink-0 group-hover:shadow-neon-lg transition-all duration-500">
              <Users className="w-10 h-10 text-background" />
            </div>
            <div>
              <div className="text-4xl font-bold text-gradient-neon mb-1">10,000+</div>
              <p className="text-muted-foreground">Expected Footfall</p>
            </div>
          </div>
          
          <div className="card-premium p-8 flex items-center gap-6 group hover:border-primary/50 transition-all duration-500">
            <div className="w-20 h-20 rounded-2xl bg-gradient-silver flex items-center justify-center shrink-0 group-hover:shadow-neon-lg transition-all duration-500">
              <Wifi className="w-10 h-10 text-background" />
            </div>
            <div>
              <div className="text-4xl font-bold text-gradient-silver mb-1">1,50,000+</div>
